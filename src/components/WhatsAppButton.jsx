...
export const WhatsAppButton = () => {
    const { phoneNumber, defaultMessage } = profileData.whatsapp;
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-10 right-10 z-[1000] w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_15px_40px_rgba(37,211,102,0.4)] group overflow-visible"
        >
            {/* Pulsing Ripple Effect */}
            <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25 scale-125 pointer-events-none"></span>
